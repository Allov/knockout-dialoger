(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'jquery', 'knockout', 'lodash', 'koco'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('jquery'), require('knockout'), require('lodash'), require('koco'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jquery, global.knockout, global.lodash, global.koco);
        global.dialoger = mod.exports;
    }
})(this, function (exports, _jquery, _knockout, _lodash, _koco) {
    'use strict';
